...
import com.example.estacioapp.model.Usuario;
import com.example.estacioapp.utilities.ValidaCampos;
...
public class CadastroActivity extends AppCompatActivity {
                        ...
                        addOnCompleteListener(CadastroActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(CadastroActivity.this, "Usuario Cadastro com Sucesso", Toast.LENGTH_SHORT).show();
                                } else {
    ...
    public void inicializaComponentes(){
        ...
        textInputLayoutConfirmacaoSenha = findViewById(R.id.TextInputConfirmacaoSenha);
        buttonCadastrar = findViewById(R.id.buttonCadastrar);

    }

    public void ValidaCamposEMascaras () {
        textInputLayoutDataNasc.getEditText().addTextChangedListener(com.estacio.app.utilities.TextMask.mask(textInputLayoutDataNasc.getEditText(),TextMask.FORMAT_DATE));
